 ...
 * Use the [RekapSaranDetailFragment.newInstance] factory method to
...
class RekapSaranDetailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RekapSaranDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RekapSaranDetailFragment().apply {
